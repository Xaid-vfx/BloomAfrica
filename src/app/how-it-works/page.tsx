                        ...
                        <div className="bg-white rounded-2xl border border-gray-200 p-8 text-center shadow-sm">
                            ...
                            <div className="grid sm:grid-cols-3 gap-4 text-left">
                                <div className="flex items-start gap-3 p-4 bg-gray-50 rounded-xl">
                                    <Clock className="w-5 h-5 text-[#14B8A6] mt-0.5 flex-shrink-0" />
                                    <div>
                                        <p className="font-medium text-[#0A1F44] text-sm">Flexible Duration</p>
                                        <p className="text-xs text-gray-500">Programs range from weeks to months</p>
                                    </div>
                                </div>
                                <div className="flex items-start gap-3 p-4 bg-gray-50 rounded-xl">
                                    <Award className="w-5 h-5 text-[#14B8A6] mt-0.5 flex-shrink-0" />
                                    <div>
                                        <p className="font-medium text-[#0A1F44] text-sm">Verified Trainers</p>
                                        <p className="text-xs text-gray-500">All trainers are vetted professionals</p>
                                    </div>
                                </div>
                                <div className="flex items-start gap-3 p-4 bg-gray-50 rounded-xl">
                                    <ShieldCheck className="w-5 h-5 text-[#14B8A6] mt-0.5 flex-shrink-0" />
                                    <div>
                                        <p className="font-medium text-[#0A1F44] text-sm">Secure Payments</p>
                                        <p className="text-xs text-gray-500">Safe and protected transactions</p>
                                    </div>
                                </div>
                            </div>
                        </div>
