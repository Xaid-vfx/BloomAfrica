    ...
    return (
        <div>
            ...
            <div className="py-20 px-6 lg:px-32">
                <h1 className="text-3xl font-medium text-center">Prentis Privacy Policy</h1>
                <p className="text-sm my-4 text-center ">Last Updated: 16th Aug, 2024</p>
                <p className="text-sm my-10">
                    Prentis respects and understands the importance of your privacy – and is therefore committed to affording complete protection to the personal information of our customers who use our products and services or visitors of our website, and of the learners whose information we may have access to and when you enroll on our website for an open position. It is in recognition of this need for security, compliance with the Nigeria Data Protection Act 2023 and Secured management of any information received /collected by us that Prentis has established this Privacy Policy. This privacy policy is applicable to our websites – www.prentis.ng and any services we provide. It also applies to our marketing practices. We ensure total transparency in all our dealings. Data Privacy is important to us and we strive to be transparent in our data collection and use practices.
                </p>
                ...
                <div className="text-sm flex flex-col">
                    ...
                    <p className="mt-2 mb-4">When you register to use Prentis, create an ID with us, or use our services for development or support, we collect information that is unique to you and identifies you. This may include your name, email address, phone number, or payment information, all in accordance with applicable law. Some information is required and other information is optional. Sometimes information regarding eligibility may be required. At times, we may rely on information from public sources.</p>
                    ...
                    <h3 className="font-medium text-lg mt-4">1.4 Prentis Emails</h3>
                    ...
                    <p className="mt-2 mb-4">Our websites may include buttons or tools that link to other companies’ services (for example, a Facebook or Google button). We may collect information about your use of these features. In addition, when you see or interact with these buttons, tools, or content, or view a Prentis web page containing them, some information from your browser may automatically be sent to the other company. Please read that company’s privacy policy for more information, as these sites may have their own privacy statements in place, which we recommend you review if you visit any linked websites. We are not responsible for the content of linked sites or any use of the sites or for the privacy practices of those other websites. We may collect information when you interact with our social networking pages or use the sign-on features.</p>

                    <h3 className="font-medium text-lg mt-4">1.6 Hosted Services Provided by Prentis</h3>
                ...
                <div className="text-sm flex flex-col">
                    <p className="mt-2 mb-4">The Prentis website may, from time to time, contain links to and from the websites of our partner networks, advertisers, and affiliates (including, but not limited to, websites on which the Prentis website is advertised). If you follow a link to any of these websites, please note that these websites have their own privacy policies, and that Prentis does not accept any responsibility or liability for these policies. Please check these policies before you submit any personal data to these websites. We make all reasonable efforts to protect your data, but please note that we cannot guarantee the security of data transmitted to our site. Transmission is at your own risk. After we have received your information, we will use strict procedures and security features to try to prevent unauthorized access.</p>
                </div>
            </div>
            <GetStarted />
            <Footer />
