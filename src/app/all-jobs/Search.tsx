...
export default function Search() {
    ...
    return (
        <div className="bg-white p-4 w-[90%] lg:w-auto lg:mx-0 rounded-2xl lg:flex items-center box_shadow x lg:p-2 lg:pl-8 lg:rounded-3xl lg:max-w-none md:max-w-xl">
            ...
            <button onClick={handleSearch} className="min-w-max text-white py-4 text-center bg-[#4A2C84] w-full  rounded-3xl font-semibold text-xs lg:text-sm lg:py-4 lg:px-10" >Search Apprenticeship</button>
