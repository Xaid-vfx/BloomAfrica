    ...
    return (
        <div className="bg-white py-20 px-6">
            <div className="max-w-5xl mx-auto">
                ...
                <div className="relative bg-[#F5F3FF] rounded-lg shadow-2xl border-8 border-double border-[#8B5CF6] p-12 md:p-16">
                    {/* Decorative Corner Elements */}
                    <div className="absolute top-4 left-4 w-12 h-12 border-t-4 border-l-4 border-[#8B5CF6]"></div>
                    <div className="absolute top-4 right-4 w-12 h-12 border-t-4 border-r-4 border-[#8B5CF6]"></div>
                    <div className="absolute bottom-4 left-4 w-12 h-12 border-b-4 border-l-4 border-[#8B5CF6]"></div>
                    <div className="absolute bottom-4 right-4 w-12 h-12 border-b-4 border-r-4 border-[#8B5CF6]"></div>
                    ...
                    <div className="max-w-3xl mx-auto">
                        ...
                        <div className="space-y-6">
                            ...
                            {/* Decorative Line */}
                            <div className="mt-8 pt-6 border-t-2 border-[#8B5CF6]/20">
