    ...
    return (
        <div className="bg-grey-50 py-20 px-6">
            <div className="max-w-5xl mx-auto">
                ...
                <div className="relative bg-white rounded-lg shadow-2xl border-8 border-double border-[#4A2C84] p-12 md:p-16">
                    {/* Decorative Corner Elements */}
                    <div className="absolute top-4 left-4 w-12 h-12 border-t-4 border-l-4 border-[#4A2C84]"></div>
                    <div className="absolute top-4 right-4 w-12 h-12 border-t-4 border-r-4 border-[#4A2C84]"></div>
                    <div className="absolute bottom-4 left-4 w-12 h-12 border-b-4 border-l-4 border-[#4A2C84]"></div>
                    <div className="absolute bottom-4 right-4 w-12 h-12 border-b-4 border-r-4 border-[#4A2C84]"></div>

                    {/* Content Container */}
                    <div className="max-w-3xl mx-auto">
                        {/* Award Icon */}
                        <div className="flex justify-center mb-6">
                            <div className="bg-[#4A2C84] rounded-full p-4">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="grid md:grid-cols-2 gap-4 mt-8">
                                <div className="flex items-start gap-3">
                                    <CheckCircle className="text-[#4A2C84] flex-shrink-0 mt-1" size={24} />
                                    <div>
                            ...
                            {/* Decorative Line */}
                            <div className="mt-8 pt-6 border-t-2 border-[#4A2C84]/20">
