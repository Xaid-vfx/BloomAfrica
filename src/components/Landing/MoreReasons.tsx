...
export default function MoreReasons() {
    return (
        <div className="py-10 px-4 relative bg-white">
            <h1 className="text-center font-semibold text-xl mb-8 lg:text-3xl lg:mb-4">More reasons to choose <br /> Bloom</h1>
            ...
            <div className="lg:flex lg:px-10">
                ...
                <ReasonCard image={r2} title="Gain Real-World Experience" content="In contrast to traditional schooling, Bloom's apprenticeships prioritise hands-on learning. You will gain practical experience through carefully curated work placements in reputable businesses that align with your career aspirations. " />
                <ReasonCard image={r3} title="Guaranteed Settlement" content="Unlike traditional apprenticeships where apprentices are often left vulnerable to exploitation, Bloom protects your interests by guaranteeing your starting capital in full. Upon successful completion of your apprenticeship, we ensure that the full balance is transferred to your chosen account, directly from your employer " />
            </div>
        </div>
    )
}