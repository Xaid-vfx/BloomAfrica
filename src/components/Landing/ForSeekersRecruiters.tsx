    ...
    return (
        <div className="flex lg:flex-row flex-col relative">
            <div className="lg:w-1/2 flex flex-col justify-between py-10 lg:py-20 px-6 lg:px-16 bg-[#F8F8FD]">
                ...
                <div><a href="/all-jobs" className="border border-[#4A2C84] text-white py-3 px-4 text-center bg-[#4A2C84] rounded-3xl font-medium text-xs lg:text-sm lg:py-3 lg:px-8" >Find Jobs</a>
