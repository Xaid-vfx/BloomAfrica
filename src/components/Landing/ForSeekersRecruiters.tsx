    ...
    return (
        <div className="flex lg:flex-row flex-col relative ">
            <div className="lg:w-1/2 flex flex-col justify-between py-10 lg:py-20 px-6 lg:px-16 bg-[#F8F8FD] ">
                <div className="ms-auto max-w-[640px]">
                ...
                <div> 
                    <div className="ms-auto max-w-[640px]"><a href="/all-jobs" className="border border-[#4A2C84] text-white py-3 px-4 text-center bg-[#4A2C84] rounded-3xl font-medium text-xs lg:text-sm lg:py-3 lg:px-8" >Find Apprenticeships</a>
            ...
            <div className="lg:w-1/2 flex flex-col justify-between py-10 lg:py-20 px-6 lg:px-16">
                <div className="me-auto max-w-[640px]">
                    ...
                    <div className="text-sm lg:text-base mb-12">
                        ...
                        <p className="my-8 flex font-[350] items-start gap-4">
                            <Image src={Image2} alt="1" width={38} />
                            No business is too small to hire. We encourage businesses of all sizes to bring in fresh talent from our platform, 
                        </p>
                        <p className="my-8 flex font-[350] items-start gap-4">
                            <Image src={Image3} alt="1" width={38} />
                            Worried about background checks? Don't be.
                        </p>
                        <p className="my-8 flex font-[350] items-start gap-4">
                            <Image src={Image4} alt="1" width={38} />
                            Create job listings that stand out, highlight your company culture and growth opportunities, 
                        </p>
                    </div>
                </div>
                <div>
                <div className="me-auto max-w-[640px]"><a href="/signup" className="border border-[#4A2C84] text-white py-3 px-4 text-center bg-[#4A2C84] rounded-3xl font-medium text-xs lg:text-sm lg:py-3 lg:px-8" >Become a Trainer</a>
                <a href="/about" className=" border border-black py-3 px-4 text-center rounded-3xl font-medium text-xs lg:text-sm lg:py-3 ml-2 lg:px-8" >Learn More</a></div>
                </div>
