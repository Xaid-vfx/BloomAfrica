    ...
    return (
        <div className="bg-[#F8F8FD] py-10 px-4 relative lg:py-16 ">
            ...
            <div className="my-12 ms-auto me-auto max-w-[1500px]">
                <p className="flex items-center gap-2 justify-end text-[#14B8A6] text-sm text-right  lg:px-8"><a href="/all-trainings" className="hover:underline cursor-pointer">Show all Jobs </a><FaArrowRightLong /></p>
