        ...
        <div className="bg-grey-50 py-16 px-4 lg:py-24">
            <div className="ms-auto me-auto lg:max-w-[1500px] max-lg:max-w-[700px]">
                ...
                <div className="lg:flex lg:px-10 gap-8">
                    ...
                    <div className="text-center my-6 flex flex-col items-center py-10 px-8 lg:w-1/3 bg-white border border-grey-200 rounded-xl hover:border-[#0D9488] transition-colors">
