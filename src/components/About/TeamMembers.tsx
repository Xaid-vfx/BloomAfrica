...
import Nathaniel from "../../assets/images/team/Nathaniel.jpg"


export default function TeamMembers() {
    return (
        <div className="lg:bg-[#f0f0fb] relative lg:pb-10">
            <div className="ms-auto me-auto max-w-[1500px] flex-col">
                ...
                <div className="lg:flex py-6 lg:py-0 px-4 grid grid-cols-2 flex-col lg:px-24 lg:flex-row lg:my-6 lg:flex-wrap   -between">
