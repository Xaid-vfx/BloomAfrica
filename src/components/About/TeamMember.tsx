...
export default function TeamMemberCard(props: Props) {
    return (
        <div className="bg-white my-3 lg:my-4 mx-2 flex flex-col justify-center items-center py-6 rounded-xl box_shadow  max-md:px-2 lg:px-8 lg:py-12 lg:w-[30%]">
            ...
            <p className="text-xs lg:text-sm mt-1 text-[#97999B] text-center">{props.designation}</p>
