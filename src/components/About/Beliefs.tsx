...
export default function Beliefs() {
    return (
        <div className="bg-[#171c1f] text-white lg:flex w-full">
            <div className="bg-[#897DD3] flex justify-center py-8 lg:py-14 lg:w-[45%]">
                <Image src={Girl} alt="girl" width={500} height={100} className="hidden lg:block" />
                <Image src={Girl} alt="girl" width={350} height={100} className="lg:hidden" />
            </div>
            <div className="lg:w-[55%] py-14 text-justify flex flex-col gap-6 px-4 lg:px-20 justify-center items-center">
                ...
                <p className="text-sm leading-7">At Bloom, our mission is to empower Africans by creating accessible local opportunities for personal and economic growth. We envision an Africa where the informal economy, alternative education, and non-traditional career paths are democratized, becoming vibrant and sustainable engines of growth.
                    <br /><br />
                    We aim to become the global leader in providing innovative education solutions that empower informal workers and MSME owners in emerging economies to unlock their full potential. Bloom is an online platform that transforms ordinary job opportunities into valuable, exciting apprenticeships that lead to recognized qualifications, accelerating career growth and fostering skilled professionals.
                    <br /><br />
