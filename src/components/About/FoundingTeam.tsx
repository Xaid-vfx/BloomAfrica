...
import Oluwasean from "../../assets/images/team/Oluwasean.png";
...
export default function FoundingTeam() {
    return (
        <div className="lg:bg-[#f0f0fb] relative lg:pb-10">
            ...
            <h2 className="text-center text-xl font-semibold lg:text-5xl lg:pt-24">Our Founding Team</h2>
            <div className="lg:flex py-6 lg:py-0 px-4 grid grid-cols-2 flex-col lg:px-24 lg:flex-row lg:my-6 lg:flex-wrap">
                ...
                <FoundingCard image={Ernest} name="Ernest Ikeh" designation="Product Designer" twitter="https://x.com/ernestikeh4" linkedin="https://www.linkedin.com/in/ernest-ikeh" />
                <FoundingCard image={Joshua} name="Joshua-Charles Odenigbo" designation="CLO" twitter="https://x.com/ernestikeh4" linkedin="https://www.linkedin.com/in/ernest-ikeh" />
                <FoundingCard image={Oluwasean} name="Oluwasean Fatudimu" designation="Legal Associate" twitter="https://x.com/ernestikeh4" linkedin="https://www.linkedin.com/in/ernest-ikeh" />
            </div>
        </div>
    )
}