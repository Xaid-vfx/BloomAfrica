...
export default function JobCard(props: Props) {
    ...
    return (
        <div className="flex items-center justify-between border border-gray-200 rounded-xl px-6 py-4 my-6 bg-white shadow-sm hover:shadow-md transition-shadow">
            <div className="flex flex-row">
                <div className='flex flex-col'>
                    <div className="flex items-center gap-6">
                        <div className="">
                            <div className="flex items-center gap-2">
                                ...
                                {props.isVerified && (
                                    <span className="text-sm text-[#14B8A6] bg-[#14B8A6]/10 px-2 py-1 rounded-full flex items-center gap-1 min-w-[150px]">
                    ...
                    <div className=" flex gap-2 my-4 items-center">
                        ...
                        {props.category && <div className="rounded-xl  border px-3 py-2 font-semibold text-xs bg-gray-100  text-[#14B8A6] min-w-max">{props.category}</div>}
                        {props.certificate && <div className="rounded-xl  border px-3 py-2 font-semibold bg-gray-100  text-xs text-[#14B8A6] min-w-max">Certificate Available</div>}
                        {props.training_mode && <div className="rounded-xl  border px-3 py-2 font-semibold bg-gray-100  text-xs text-[#14B8A6] min-w-max">{props.training_mode}</div>}
                    </div>
                </div>
            </div>
            <div className="">
                <div className="flex flex-col gap-2">
                    ...
                    <a href={`all-trainings/job?id=${props.id}`} className=" text-white py-3 text-center bg-[#14B8A6]  rounded-lg font-medium px-14 hover:bg-[#0D9488] transition-colors" >Enroll</a>
                </div>
