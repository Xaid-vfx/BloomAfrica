        ...
        <div className="">
            ...
            <div className="flex flex-col gap-3   py-8 px-5">
                ...
                <div className="text-[#515B6F] flex flex-col gap-2">
                    <div className='flex'>
                        <input type='checkbox' className="accent-[#0A1F44]" checked={props.selectedTypes?.includes('Full Time')} value="Full Time" onChange={(e) => {
                            props.handleTypeChange("Full Time")
                        }} /><p className="ml-3 text-sm">Full Time</p>
                    </div>
                    <div className='flex'>
                        <input type='checkbox' className="accent-[#0A1F44]" checked={props.selectedTypes?.includes('Part Time')} value="Part Time" onChange={(e) => {
